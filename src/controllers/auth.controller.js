...
const registerUser = asyncHandler (async(req, res) => {
   ...
   const { unHashedToken, hashedToken, tokenExpiry } =
     ...
     return res.status(201).json(new ApiResponse(200, {user: createdUser},
...
const forgotPasswordRequest = asyncHandler(async(res, req) => {
    ...
    user.forgottPasswordToken = hashedToken
    user.forgottPasswordExpiry = tokenExpiry
...
const resetForgotPassword = asyncHandler(async(res, req) => {
    ...
    const user = await User.findOne({
        forgottPasswordToken: hashedToken,
        forgottPasswordExpiry: {$gt: Date.now()}
    })
    ...
    user.forgottPasswordExpiry = undefined
    user.forgottPasswordToken = undefined
